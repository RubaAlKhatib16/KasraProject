...
<head>
  ...
  <style>
    /* كل الـ CSS الذي أرسلته سابقاً - يبقى كما هو دون تغيير */
    * {
      margin: 0;
      padding: 0;
  ...
  <div class="dashboard">
    ...
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav">
        <a href="{{ route('seller.dashboard') }}" class="nav-item active"><i class="fas fa-chart-line"></i> لوحة
          التحكم</a>
    ...
    <main class="main-content">
      ...
      <div class="quick-actions">
        ...
        <button class="action-btn" onclick="alert('تقرير المبيعات قريباً')"><i class="fas fa-file-alt"></i> تقرير
          المبيعات</button>
      </div>
