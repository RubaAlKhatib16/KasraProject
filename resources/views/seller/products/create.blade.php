...
<head>
    ...
    <title>كِسرة · إضافة منتج</title>
    <link href="https://fonts.googleapis.com/css2?family=Cairo:wght@300;400;500;600;700;800&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        /* نفس الـ CSS المستخدم في edit.blade.php بالكامل */
        * {
            margin: 0;
            padding: 0;
...
<body>
        ...
        <form method="POST" action="{{ route('seller.products.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required placeholder="مثال: آيفون 15 برو">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="stock" value="{{ old('stock', 0) }}" placeholder="الكمية">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="installments_count" value="{{ old('installments_count', 0) }}" min="0" max="24">
                    <small>0 = غير متاح للتقسيط | 3 = 3 أقساط | 6 = 6 أقساط</small>
                </div>
                <div class="form-group full-width">
                    <label><i class="fas fa-align-right"></i> الوصف</label>
                    <textarea name="description" rows="4" placeholder="وصف المنتج...">{{ old('description') }}</textarea>
                </div>
                <div class="form-group full-width">
    ...
    <small>يمكنك اختيار أكثر من صورة (اختياري)</small>
            ...
            <div class="actions">
                <button type="submit" class="btn-save"><i class="fas fa-save"></i> حفظ المنتج</button>
