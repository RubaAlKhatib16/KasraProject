...
<head>
    ...
    <style>
        * {
        ...
        /* الحاوية الرئيسية - خلفية داكنة شفافة */
        .container {
            max-width: 900px;
            margin: 0 auto;
        ...
        <form method="POST" action="{{ route('seller.products.update', $product) }}" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="installments_count" value="{{ old('installments_count', $product->installments_count) }}" min="0" max="24">
